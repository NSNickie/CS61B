...
public class LinkedListDequeTest {
    ...
    public void testGetInvalidParam() {
        ...
        assertThat(lld1.get(2)).isEqualTo(10086);
        assertThat(lld1.get(3)).isEqualTo(20000);
    }
    ...
    public void testRemoveFirst(){
        ...
        assertThat(lld1.toList()).containsExactly(10086,20000).inOrder();
        lld1.removeFirst();
        lld1.removeFirst();
    ...
    public void testRemoveLast(){
        ...
        assertThat(lld1.toList()).containsExactly(1,10086).inOrder();
        lld1.removeLast();
        lld1.removeLast();
        assertThat(lld1.toList()).containsExactly();
    }
